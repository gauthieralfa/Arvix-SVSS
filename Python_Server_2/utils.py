...
def generate_keys_car():
    ...
    file1 = open(os.getcwd()+"\\Arvix-SVSS-main\\Clean_Code\\all_keys\\priv_car.key")
    priv_key=file1.read()
    ...
    file2 = open("Arvix-SVSS-main/Clean_Code/all_keys/pub_spPKCS1.pem")
    pub_key=file2.read()
    public_key=rsa.PublicKey.load_pkcs1(pub_key)
    file2.close()

    #USE FOR DECRYPT WITH PYTHON - Update : Use for Signature
    file3 = open("Arvix-SVSS-main/Clean_Code/all_keys/priv_sp.txt","rb")
    priv_key=file3.read()
...
def generate_keys():
    ...
    file1 = open(os.getcwd()+"\\Arvix-SVSS-main\\Clean_Code\\all_keys\\priv_sp.pem")
    priv_key=file1.read()
...
def get_certificate(certif_file):
    file= open("Arvix-SVSS-main/Clean_Code/all_keys/"+certif_file, "r")
...
def get_certificate_der(certif_file):
    file= open("Arvix-SVSS-main/Clean_Code/all_keys/"+certif_file, "rb")
